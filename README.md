...
| Unit      | Create New Withdrawal                              | After above, select 1 at return menu Select 1 at main menu Select 2 at transaction menu Input "23.45" Select 5 at categories menu | The most recent line in the Robert1.csv file should be "(date),-23.45,other"                                                                                                                                                     | Y         |
